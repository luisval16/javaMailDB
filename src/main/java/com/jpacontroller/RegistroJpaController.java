 ...
 */
package com.jpacontroller;

import com.entity.Registro;
import com.jpacontroller.exceptions.NonexistentEntityException;
import com.jpacontroller.exceptions.PreexistingEntityException;
...
public class RegistroJpaController implements Serializable {
    ...
    public void create(Registro registro) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findRegistro(registro.getId()) != null) {
